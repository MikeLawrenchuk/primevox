...
from pv_sdk.analysis import explore_modular_arithmetic, analyze_graph_properties, perform_statistical_analysis
from pv_sdk.visualization import graphical_representation_with_labels, detect_graph_communities, calculate_centrality_measures
...
def main():
    ...
    results = {"primes": primes, "modular_results": modular_results, "twin_primes": twin_primes[:5]}
    ...
    append_historical_record("historical_data.json", "recent_prime_analysis", {"prime_limit": prime_limit, "found_primes": len(primes)})
